...
if(ALLOW_INSTALL)
  message(WARNING "Install target is enabled. This will install all LibreStation files into:
...
You are not compiling LibreStation with a supported compiler.
It may not even build successfully.
LibreStation only supports the Clang and MSVC compilers.
...
if(WIN32)
  message(WARNING "
*************** UNSUPPORTED CONFIGURATION ***************
You are compiling LibreStation with CMake on Windows.
It may not even build successfully.
LibreStation only supports MSBuild on Windows.
No support will be provided, continue at your own risk.
*********************************************************")
endif()
