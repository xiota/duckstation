@ECHO OFF
REM Script to provide and easy way to update and edit .ts files for LibreStation.
REM Usage: drag and drop a librestation .ts file on this batch file
REM Author: RaydenX93
REM Credits to Stenzek, Sam Pearman
TITLE LibreStation - Create, and Edit .ts files (Drag n Drop)
...
:noarg
ECHO ===================================================================
ECHO LibreStation - Create, Update and Edit .ts files (Drag n Drop)
ECHO ===================================================================
...
IF NOT DEFINED langcode (
	...
	SET filename=librestation-qt_%langcode%.ts
)
